...
mod top {
    ...
    macro_rules! nomenclature {
        ( MDC_MOC_TOP ) => { 70u16 };
        ( MDC_ATTR_CLASS ) => { 2491u16 };
        ( MDC_ATTR_NAME_BINDING ) => { 2510u16 };
        ( MDC_ATTR_LOCALE ) => { 2600u16 };
        ( MDC_NOTI_ATTR_UPDT ) => { 3330u16 };
    }
    // define types
    pub type OidType = u16;
    pub type PrivateOid = u16;
    pub type Handle = u16;
    pub type InstNumber = u16;
    pub type MdsContext = u16;
